...
var managedServerKeys = map[string]bool{
	...
	"float": true, "data-ciphers": true, "data-ciphers-fallback": true, "tls-ciphersuites": true, "auth": true, "cipher": true,
...
var settingsWriteOrder = []string{
	...
	"data-ciphers", "data-ciphers-fallback", "tls-ciphersuites", "cipher", "auth", "tls-version-min",
